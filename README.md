...
To compile Cubiomes and you own programs stored in the `src` folder, enter the following command.
```
make
```
To compile and run your program `src/filename.c`, enter the following command. Notice that `filename` does not include the extension.
```
